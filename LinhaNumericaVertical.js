...
function updateLineNumbers() {
  ...
  let editorContent = document.getElementById("fileContent"); //Obtém o id do elemento textarea onde o conteúdo do arquivo é digitado
...
function syncScroll() {
  let lineNumberDiv = document.getElementById("vertical_number_line"); //Obtém o elemento div que contém os números das linhas
  let editorContent = document.getElementById("fileContent"); //Obtém o elemento textarea onde o conteúdo do arquivo é digitado
...
window.addEventListener("DOMContentLoaded", function() {
  ...
  document.getElementById("fileContent").addEventListener("input", updateLineNumbers); //Adiciona um ouvinte de eventos para o evento de input no elemento textarea fileContent, para atualizar os números das linhas sempre que houver uma mudança no conteúdo
  document.getElementById("fileContent").addEventListener("scroll", syncScroll); //Adiciona um ouvinte de eventos para o evento de rolagem no elemento textarea fileContent, para sincronizar a rolagem da linha vertical com o conteúdo do arquivo
